...
{
    public class ConsolDistributedLoad : BaseModel
    {
        private double _distributedLoad;
        /// <summary>
        /// kg/m^2
        /// </summary>
        [Input(Label = "q [kg/m\u00B2]", ControlType = ControlTypes.Input)]
        ...
        /// mm
        /// </summary>
        [Input(Label = "\u03B4max [mm]", ControlType = ControlTypes.Output)]
        public double FMax
        {
            get { return _fMax; }
            set
        ...
        /// cm^3
        /// </summary>
        [Input(Label = "Wmin [cm\u00B3]", Floating = 2, ControlType = ControlTypes.Output)]
        public double WMin
        {
            get { return _wMin; }
            set
        ...
        public ConsolDistributedLoad()
        {
            this.DistributedLoad = 100.0;
            this.LeftSpan = 0.8125;
            this.RightSpan = 0.8125;
            this.L = 3.0;
        ...
        public override void Calculate()
        {
            ...
            double fr = this.FMax; // mm

            double ix = load * Math.Pow(l, 4) / (8 * e * fr); // mm^4
            this.Ix = ix * 1e-4; // cm^4

            double centeralMoment = load * Math.Pow(l, 2) / 2; ; // N.mm
            double wMin = centeralMoment / maxStress; // mm^3
            this._centeralMoment = centeralMoment / 1e8; // ton.m
